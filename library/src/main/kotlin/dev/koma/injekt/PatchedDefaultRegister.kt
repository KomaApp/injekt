...
/**
 * Thread-safe implementation of InjektRegistrar with concurrent dependency management.
 *
 * This registrar provides:
 * - Thread-safe singleton factory registration and resolution
 * - Concurrent hash maps for efficient multi-threaded access
 * - Support for keyed factories and per-thread instances
 * - Logger factory support with type checking
 */
